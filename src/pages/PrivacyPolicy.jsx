export default function PrivacyPolicy() {
  return (
    <div className="bg-red-600 ">
      <p>{`Vistaar WebXVistaar WebX Branding Services Overview Brand Name Brand
        Advertising Brand Strategy Brand Experience Social Media Marketing UI/UX
        Video Marketing Integrated Marketing Overview Marketing Strategy Website
        Design Digital Marketing Graphic Designing Logo and Merchandise About Us
        Projects Blogs Contact Us Get a Quote 1. Introduction Welcome to Vistaar
        Webx. Vistaar Webx (“us”, “we”, or “our”) operates Vistaarwebx.com
        (hereinafter referred to as “Service”). Our Privacy Policy governs your
        visit to Vistaarwebx.com, and explains how we collect, safeguard and
        ...
        (“agreement”). 2. Definitions SERVICE means the Vistaarwebx.com website
        operated by Vistaar Webx. PERSONAL DATA means data about a living
        ...
        corresponds to the Data Subject, who is the subject of Personal Data. 3.
        ...
        you. 4. Types of Data Collected Personal Data While using our Service,
        ...
        limited to: 0.1. Email address 0.2. First name and last name 0.3. Phone
        number 0.4. Address, Country, State, Province, ZIP/Postal code, City
        ...
        unsubscribe link. Usage Data We may also collect information that your
        browser sends whenever you visit our Service or when you access Service
        by or through any device (“Usage Data”). This Usage Data may include
        ...
        access Service with a device, this Usage Data may include information
        such as the type of device you use, your device unique ID, the IP
        address of your device, your device operating system, the type of
        Internet browser you use, unique device identifiers and other diagnostic
        data. Location Data We may use and store information about your location
        if you give us permission to do so (“Location Data”). We use this data
        ...
        Service at any time by way of your device settings. Tracking Cookies
        ...
        identification) number, office location and other data. 5. Use of Data
        Vistaar Webx uses the collected data for various purposes: 0.1. to
        provide and maintain our Service; 0.2. to notify you about changes to
        our Service; 0.3. to allow you to participate in interactive features of
        our Service when you choose to do so; 0.4. to provide customer support;
        0.5. to gather analysis or valuable information so that we can improve
        our Service; 0.6. to monitor the usage of our Service; 0.7. to detect,
        prevent and address technical issues; 0.8. to fulfil any other purpose
        for which you provide it; 0.9. to carry out our obligations and enforce
        our rights arising from any contracts entered into between you and us,
        including for billing and collection; 0.10. to provide you with notices
        ...
        information; 0.12. in any other way we may describe when you provide the
        information; 0.13. for any other purpose with your consent. 6. Retention
        of Data We will retain your Personal Data only for as long as is
        ...
        shorter period, except when this data is used to strengthen the security
        or to improve the functionality of our Service, or we are legally
        obligated to retain this data for longer time periods. 7. Transfer of
        ...
        of such information represents your agreement to that transfer. Vistaar
        Webx will take all the steps reasonably necessary to ensure that your
        data is treated securely and in accordance with this Privacy Policy and
        no transfer of your Personal Data will take place to an organisation or
        a country unless there are adequate controls in place including the
        security of your data and other personal information. 8. Disclosure of
        Data We may disclose personal information that we collect, or you
        provide: 0.1. Business Transaction. If we or our subsidiaries are
        involved in a merger, acquisition or asset sale, your Personal Data may
        be transferred. 0.2. Other cases. We may disclose your information also:
        0.2.1. to our subsidiaries and affiliates; 0.2.2. to contractors,
        service providers, and other third parties we use to support our
        business; 0.2.3. to fulfill the purpose for which you provide it; 0.2.4.
        for the purpose of including your company’s logo on our website; 0.2.5.
        for any other purpose disclosed by us when you provide the information;
        0.2.6. with your consent in any other cases; 0.2.7. if we believe
        disclosure is necessary or appropriate to protect the rights, property,
        or safety of the Company, our customers, or others. 9. Security of Data
        ...
        (GDPR) If you are a resident of the European Union (EU) and European
        Economic Area (EEA), you have certain data protection rights, covered by
        GDPR. We aim to take reasonable steps to allow you to correct, amend,
        ...
        removed from our systems, please email us at support@vistaarwebx.com. In
        ...
        you; 0.2. the right of rectification. You have the right to have your
        ...
        European Economic Area (EEA). 11. Your Data Protection Rights under the
        California Privacy Protection Act (CalOPPA) CalOPPA is the first state
        law in the nation to require commercial websites and online services to
        post a privacy policy. The law’s reach stretches well beyond California
        to require a person or company in the United States (and conceivable the
        ...
        this policy. According to CalOPPA we agree to the following: 0.1. users
        can visit our site anonymously; 0.2. our Privacy Policy link includes
        the word “Privacy”, and can easily be found on the home page of our
        website; 0.3. users will be notified of any privacy policy changes on
        our Privacy Policy Page; 0.4. users are able to change their personal
        information by emailing us at support@vistaarwebx.com. Our Policy on “Do
        Not Track” Signals: We honor Do Not Track signals and do not track,
        plant cookies, or use advertising when a Do Not Track browser mechanism
        ...
        enable or disable Do Not Track by visiting the Preferences or Settings
        page of your web browser. 12. Your Data Protection Rights under the
        California Consumer Privacy Act (CCPA) If you are a California resident,
        you are entitled to learn what data we collect about you, ask to delete
        your data and not to sell (share) it. To exercise your data protection
        rights, you can make certain requests and ask us: 0.1. What personal
        information we have about you. If you make this request, we will return
        to you: 0.0.1. The categories of personal information we have collected
        about you. 0.0.2. The categories of sources from which we collect your
        personal information. 0.0.3. The business or commercial purpose for
        collecting or selling your personal information. 0.0.4. The categories
        of third parties with whom we share personal information. 0.0.5. The
        ...
        you in the previous 12 months. 0.2. To delete your personal information.
        ...
        time. If you submit a request to stop selling your personal information,
        we will stop making such transfers. Please note, if you ask us to delete
        ...
        support@vistaarwebx.com. Your data protection rights, described above,
        ...
        website. The CCPA took effect on 01/01/2020. 13. Service Providers We
        ...
        use it for any other purpose. 14. Analytics We may use third-party
        Service Providers to monitor and analyze the use of our Service. 15.
        CI/CD tools We may use third-party Service Providers to automate the
        development process of our Service. 16. Behavioral Remarketing We may
        use remarketing services to advertise on third party websites to you
        ...
        our Service. 17. Links to Other Sites Our Service may contain links to
        ...
        policies or practices of any third party sites or services. For example,
        the outlined privacy policy has been made using PolicyMaker.io, a free
        tool that helps create high-quality legal documents. PolicyMaker’s
        privacy policy generator is an easy-to-use tool for creating a privacy
        policy for blog, website, e-commerce store or mobile app. 18. Children’s
        Privacy Our Services are not intended for use by children under the age
        of 18 (“Child” or “Children”). We do not knowingly collect personally
        ...
        information from our servers. 19. Changes to This Privacy Policy We may
        ...
        effective when they are posted on this page. 20. Contact Us If you have
        any questions about this Privacy Policy, please contact us by email:
        support@vistaarwebx.com. This Privacy Policy was created for
        Vistaarwebx.com by PolicyMaker.io on 2023-02-17. Vistaar Webx is your
        one-stop tailored destination for all your branding needs. Be it Website
        development or social media management, Vistaar is a creative branding
        agency that works concurrently with your organization to enrich the
        brand and expand business affairs. Facebook-f Ti-linkedin Youtube
        Instagram Pinterest-p Branding Services Logo and Merchandise Social
        Media Marketing UI/Ux Brand Communication Brand Advertising Video
        Marketing Integrated Marketing Brand Advertising Brand Name Brand
        Experience Marketing Strategy Website Design Digital Marketing Company
        About Vistaar Contact & support FAQ Company history Get a Quote Hiring
        Privacy Policy Contact Information +91 955-990-3700
        hello@vistaarwebx.com 2 Floor, Patel Complex, Nexus co-working Opposite
        DB Mall, MP Nagar, Bhopal-462011 © 2024 Made by SWS LLP`}</p>
    </div>
  );
}
